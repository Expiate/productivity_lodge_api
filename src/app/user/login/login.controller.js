...
/**
 * This Async Function tries to find a User in the DB that has the same Email/Password that
 * the data provided in req param and its status is Active, then proceeds to create a JWT
 * Signed Token using the email and returns it in JSON
 *
 * @param {*} req
 * @param {*} res
 * @returns Response
...
async function login(req, res) {
    ...
    res.status(200).json({ accessToken: accessToken, user: user.username })
}
